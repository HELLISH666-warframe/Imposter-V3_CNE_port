...
function create() {
	...
	if(FlxG.save.data.antialiasing) logoBl.antialiasing = true;
	...
	if(FlxG.save.data.antialiasing) titleText.antialiasing = true;
	...
	logo.screenCenter();
	if(FlxG.save.data.antialiasing) logo.antialiasing = true;
	...
	if(FlxG.save.data.antialiasing) ngSpr.antialiasing = true;
