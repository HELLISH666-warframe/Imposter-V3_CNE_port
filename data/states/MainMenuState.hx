...
import funkin.options.OptionsMenu;
	...
	override function create()
	{
		...
		redImpostor.frames = Paths.getSparrowAtlas('menus/mainmenu/impostorMenu');
		...
		greenImpostor.frames = Paths.getSparrowAtlas('menus/mainmenu/impostorMenu');
		...
		for(i in 0...optionShit.length) {
			...
			testButton.ID = i;
			testButton.frames = Paths.getSparrowAtlas('menus/mainmenu/ButtonSheet');
